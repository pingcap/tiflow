...
func TestSplitUpdateEventWhenDisableOldValue(t *testing.T) {
	...
	deleteEventIndex := 0
	require.Len(t, node.eventBuffer[deleteEventIndex].Row.Columns, 0)
	require.Len(t, node.eventBuffer[deleteEventIndex].Row.PreColumns, 3)
	nilColIndex := 0
	require.Nil(t, node.eventBuffer[deleteEventIndex].Row.PreColumns[nilColIndex])
	...
	insertEventIndex := 1
	require.Len(t, node.eventBuffer[insertEventIndex].Row.Columns, 3)
	require.Len(t, node.eventBuffer[insertEventIndex].Row.PreColumns, 0)
}
