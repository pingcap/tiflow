...
func (p *oldPorcessor) Run(ctx context.Context) {
...
func (p *oldPorcessor) writeDebugInfo(w io.Writer) {
...
func (p *oldPorcessor) positionWorker(ctx context.Context) error {
...
func (p *oldPorcessor) ddlPullWorker(ctx context.Context) error {
...
func (p *oldPorcessor) workloadWorker(ctx context.Context) error {
...
func (p *oldPorcessor) flushTaskPosition(ctx context.Context) error {
...
func (p *oldPorcessor) flushTaskStatusAndPosition(ctx context.Context) error {
	if p.isStopped() {
		return cerror.ErrAdminStopProcessor.GenWithStackByArgs()
	}
...
func (p *oldPorcessor) removeTable(tableID int64) {
	p.stateMu.Lock()
...
func (p *oldPorcessor) handleTables(ctx context.Context, status *model.TaskStatus) (tablesToRemove []model.TableID, err error) {
...
func (p *oldPorcessor) globalStatusWorker(ctx context.Context) error {
...
func (p *oldPorcessor) addTable(ctx context.Context, tableID int64, replicaInfo *model.TableReplicaInfo) {
	p.stateMu.Lock()
	defer p.stateMu.Unlock()
...
func (p *oldPorcessor) sorterConsume(
	ctx context.Context,
	tableID int64,
	tableName string,
...
func (p *oldPorcessor) pullerConsume(
	ctx context.Context,
	plr puller.Puller,
	sorter puller.EventSorter,
) {
...
func (p *oldPorcessor) stop(ctx context.Context) error {
...
func (p *oldPorcessor) isStopped() bool {
...
func (p *oldPorcessor) sendError(err error) {
	select {
	case p.errCh <- err:
	default:
