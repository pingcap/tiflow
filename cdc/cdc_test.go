...
func (s *CDCSuite) TestMultiDataType(c *C) {
	...
	sql := `
CREATE TABLE test.cdc_multi_data_type (
...
`
	...
	expectedReplaceSQL := "REPLACE INTO `test`.`cdc_multi_data_type`" +
		...
		"(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);"
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(`INSERT INTO test.cdc_multi_data_type(t_boolean, t_bigint, t_double, t_decimal, t_bit
		,t_date, t_datetime, t_timestamp, t_time, t_year
		,t_char, t_varchar, t_blob, t_text, t_enum
		,t_set, t_json) VALUES
	...
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(`INSERT INTO test.cdc_multi_data_type(t_boolean) VALUES(TRUE);`)
	}, func(mock sqlmock.Sqlmock) {
		mock.ExpectBegin()
		mock.ExpectExec(expectedReplaceSQL).
	...
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(`INSERT INTO test.cdc_multi_data_type(t_boolean) VALUES(FALSE);`)
	}, func(mock sqlmock.Sqlmock) {
		mock.ExpectBegin()
		mock.ExpectExec(expectedReplaceSQL).
	...
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(`INSERT INTO test.cdc_multi_data_type(t_bigint) VALUES(-9223372036854775808);`)
	}, func(mock sqlmock.Sqlmock) {
		mock.ExpectBegin()
		mock.ExpectExec(expectedReplaceSQL).
	...
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(`INSERT INTO test.cdc_multi_data_type(t_bigint) VALUES(9223372036854775807);`)
	}, func(mock sqlmock.Sqlmock) {
		mock.ExpectBegin()
		mock.ExpectExec(expectedReplaceSQL).
	...
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(`INSERT INTO test.cdc_multi_data_type(t_json) VALUES('{"key1": "value1", "key2": "value2"}');`)
	}, func(mock sqlmock.Sqlmock) {
		mock.ExpectBegin()
		mock.ExpectExec(expectedReplaceSQL).
	...
	sql = "DROP TABLE test.cdc_multi_data_type"
	s.RunAndCheckSync(c, func(execute func(string, ...interface{})) {
		execute(sql)
	}, func(mock sqlmock.Sqlmock) {
		mock.ExpectBegin()
