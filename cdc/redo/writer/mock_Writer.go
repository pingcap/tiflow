...
func (_m *MockWriter) EmitCheckpointTs(ctx context.Context, ts uint64) error {
...
func (_m *MockWriter) EmitResolvedTs(ctx context.Context, ts uint64) error {
	ret := _m.Called(ctx, ts)
...
func (_m *MockWriter) FlushLog(ctx context.Context, tableID int64, ts uint64) error {
...
func (_m *MockWriter) GetCurrentResolvedTs(ctx context.Context, tableIDs []int64) (map[int64]uint64, error) {
...
func (_m *MockWriter) SendDDL(ctx context.Context, ddl *model.RedoDDLEvent) error {
...
func (_m *MockWriter) WriteLog(ctx context.Context, tableID int64, rows []*model.RedoRowChangedEvent) (uint64, error) {
