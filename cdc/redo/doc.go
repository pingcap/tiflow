...
Each log file contains batch of model.RedoRowChangedEvent or model.RedoDDLEvent records wrote into different file with defaultMaxLogSize 64 MB. If larger than 64 MB will auto rotated to a new file.
