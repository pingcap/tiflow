...
func (_m *MockReader) ReadNextDDL(ctx context.Context, maxNumberOfEvents uint64) ([]*model.RedoDDLEvent, error) {
...
func (_m *MockReader) ReadNextLog(ctx context.Context, maxNumberOfEvents uint64) ([]*model.RedoRowChangedEvent, error) {
	ret := _m.Called(ctx, maxNumberOfEvents)
...
func (_m *MockReader) ResetReader(ctx context.Context, startTs uint64, endTs uint64) error {
