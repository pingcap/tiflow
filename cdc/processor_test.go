...
type mockTsRWriter struct {
	...
	memInfo     *model.TaskInfo
	storageInfo *model.TaskInfo
}
...
func (s *mockTsRWriter) UpdateInfo(ctx context.Context) (oldInfo *model.TaskInfo, newInfo *model.TaskInfo, err error) {
	oldInfo = s.memInfo
