...
func newDDLPuller(ctx cdcContext.Context, up *upstream.Upstream, startTs uint64) (DDLPuller, error) {
...
func (h *ddlPullerImpl) handleDDL(rawDDL *model.RawKVEntry) error {
	if rawDDL == nil {
		return nil
	}
