...
<<<<<<< HEAD:cdc/scheduler/internal/v3/scheduler_basic.go
...
>>>>>>> ce736c3f5 (schedulerV3(ticdc): burst add table in a batch way to delay resource allocation (#6836)):cdc/scheduler/internal/v3/scheduler/scheduler_basic.go
	changefeedID model.ChangeFeedID,
) *scheduleTask {
