...
type Checkpoint struct {
	...
	TableIDs     []github_com_pingcap_tiflow_cdc_model.TableID `protobuf:"varint,3,rep,packed,name=table_id,json=tableId,proto3,casttype=github.com/pingcap/tiflow/cdc/model.TableID" json:"table_id,omitempty"`
}
...
func (m *Checkpoint) GetTableIDs() []github_com_pingcap_tiflow_cdc_model.TableID {
	if m != nil {
		return m.TableIDs
	}
	return nil
...
var fileDescriptor_ab4bb9c6b16cfa4d = []byte{
	...
	,
}
...
func (m *Checkpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.TableIDs) > 0 {
		dAtA2 := make([]byte, len(m.TableIDs)*10)
		var j1 int
		...
		i = encodeVarintTableSchedule(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0x1a
	}
	if m.ResolvedTs != 0 {
