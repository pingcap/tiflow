...
type Message struct {
	...
	Checkpoints           map[github_com_pingcap_tiflow_cdc_model.TableID]Checkpoint `protobuf:"bytes,9,rep,name=checkpoints,proto3,castkey=github.com/pingcap/tiflow/cdc/model.TableID" json:"checkpoints" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Message) GetCheckpoints() map[github_com_pingcap_tiflow_cdc_model.TableID]Checkpoint {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[github_com_pingcap_tiflow_cdc_model.TableID]Checkpoint)(nil), "pingcap.tiflow.cdc.schedulepb.Message.CheckpointsEntry")
...
var fileDescriptor_ab4bb9c6b16cfa4d = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Checkpoints) > 0 {
		for k := range m.Checkpoints {
			...
			i--
			dAtA[i] = 0x12
			i = encodeVarintTableSchedule(dAtA, i, uint64(k))
			i--
			dAtA[i] = 0x8
			i = encodeVarintTableSchedule(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x4a
		}
	}
...
func (m *Message) Size() (n int) {
	...
	if len(m.Checkpoints) > 0 {
		for k, v := range m.Checkpoints {
			...
			_ = v
			l = v.Size()
			mapEntrySize := 1 + sovTableSchedule(uint64(k)) + 1 + l + sovTableSchedule(uint64(l))
			n += mapEntrySize + 1 + sovTableSchedule(uint64(mapEntrySize))
		}
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.Checkpoints == nil {
				m.Checkpoints = make(map[github_com_pingcap_tiflow_cdc_model.TableID]Checkpoint)
			}
			var mapkey int64
			mapvalue := &Checkpoint{}
			for iNdEx < postIndex {
			...
			m.Checkpoints[github_com_pingcap_tiflow_cdc_model.TableID(mapkey)] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTableSchedule(dAtA[iNdEx:])
