...
//func getSaramaMetrics(saramaConfig *sarama.Config, metricName string) interface{} {
//	return saramaConfig.MetricRegistry.GetOrRegister(metricName, saramaConfig.MetricRegistry)
//}
