...
func TestColumnsDispatcher(t *testing.T) {
	...
	tidbTableInfo := &timodel.TableInfo{
		...
		Columns: []*timodel.ColumnInfo{
			{ID: 1, Name: ast.NewCIStr("col2"), Offset: 1, FieldType: *types.NewFieldType(mysql.TypeLong)},
			{ID: 2, Name: ast.NewCIStr("col1"), Offset: 0, FieldType: *types.NewFieldType(mysql.TypeLong)},
			{ID: 3, Name: ast.NewCIStr("col3"), Offset: 2, FieldType: *types.NewFieldType(mysql.TypeLong)},
		},
	}
