...
func TestIndexValueDispatcherxx(t *testing.T) {
	...
	_ = helper.DDL2Event("create table airbnbsim.t2(`pk` varchar(32) not null, `sk` varchar(32) not null, `ts` timestamp(6) not null, v varchar(10240) default null, primary key (`pk`, `sk`, `ts`))")
