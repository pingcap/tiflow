...
func rowChangeToMaxwellMsg(e *model.RowChangedEvent) (*mqMessageKey, *maxwellMessage) {
	var partition *int64
...
func ddlEventToMaxwellMsg(e *model.DDLEvent) (*mqMessageKey, *ddlMaxwellMessage) {
	key := &mqMessageKey{
		Ts:     e.CommitTs,
