...
// DecodeMsg implements msgp.Decodable
func (z *RowChangedEvents) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0002 uint32
	zb0002, err = dc.ReadArrayHeader()
	if err != nil {
		err = msgp.WrapError(err)
	...
	if cap((*z)) >= int(zb0002) {
		...
		(*z) = make(RowChangedEvents, zb0002)
	}
	for zb0001 := range *z {
		if dc.IsNil() {
			err = dc.ReadNil()
...
// EncodeMsg implements msgp.Encodable
func (z RowChangedEvents) EncodeMsg(en *msgp.Writer) (err error) {
...
// MarshalMsg implements msgp.Marshaler
func (z RowChangedEvents) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *RowChangedEvents) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0002 uint32
	zb0002, bts, err = msgp.ReadArrayHeaderBytes(bts)
	if err != nil {
		err = msgp.WrapError(err)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z RowChangedEvents) Msgsize() (s int) {
