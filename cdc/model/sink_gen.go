...
// DecodeMsg implements msgp.Decodable
func (t *TableName) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "db-name":
			t.Schema, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "Schema")
				return
			}
		case "tbl-name":
			t.Table, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "Table")
				return
			}
		case "tbl-id":
			t.TableID, err = dc.ReadInt64()
			if err != nil {
				err = msgp.WrapError(err, "TableID")
				return
			}
		case "is-partition":
			t.IsPartition, err = dc.ReadBool()
			if err != nil {
...
// EncodeMsg implements msgp.Encodable
func (t *TableName) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 4
	// write "db-name"
	...
	err = en.WriteBool(t.IsPartition)
	if err != nil {
		err = msgp.WrapError(err, "IsPartition")
		return
	}
...
func (t *TableName) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "db-name":
			t.Schema, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Schema")
				return
			}
		case "tbl-name":
			t.Table, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Table")
				return
			}
		case "tbl-id":
			t.TableID, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "TableID")
				return
			}
		case "is-partition":
			t.IsPartition, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "IsPartition")
				return
			}
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (t *TableName) Msgsize() (s int) {
	s = 1 + 8 + msgp.StringPrefixSize + len(t.Schema) + 9 + msgp.StringPrefixSize + len(t.Table) + 7 + msgp.Int64Size + 13 + msgp.BoolSize
	return
}
