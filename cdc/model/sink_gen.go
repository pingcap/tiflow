...
func (z *ColumnInfo) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "origin_default":
			err = z.OriginDefaultValue.DecodeMsg(dc)
			if err != nil {
...
func (z *ColumnInfo) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = z.OriginDefaultValue.EncodeMsg(en)
	if err != nil {
		err = msgp.WrapError(err, "OriginDefaultValue")
		return
	}
...
func (z *ColumnInfo) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o, err = z.OriginDefaultValue.MarshalMsg(o)
	if err != nil {
		err = msgp.WrapError(err, "OriginDefaultValue")
		return
	}
...
func (z *ColumnInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "origin_default":
			bts, err = z.OriginDefaultValue.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "OriginDefaultValue")
				return
			}
...
func (z *ColumnInfo) Msgsize() (s int) {
	s = 1 + 5 + msgp.StringPrefixSize + len(z.Name) + 15 + z.OriginDefaultValue.Msgsize() + 5 + msgp.ByteSize + 8 + msgp.Uint64Size
	return
}
...
func (z *RedoDDLEvent) Msgsize() (s int) {
	...
	s += 5 + msgp.ByteSize + 11 + z.TableName.Msgsize() + 8 + msgp.ArrayHeaderSize
	for za0001 := range z.Columns {
		if z.Columns[za0001] == nil {
			s += msgp.NilSize
		} else {
