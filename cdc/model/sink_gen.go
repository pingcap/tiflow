...
func (z *RedoRowChangedEvent) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "indexColumns":
			...
			if cap(z.IndexColumns) >= int(zb0003) {
				z.IndexColumns = (z.IndexColumns)[:zb0003]
			} else {
				z.IndexColumns = make([]*RedoColumn, zb0003)
			}
			for za0002 := range z.IndexColumns {
				if dc.IsNil() {
					err = dc.ReadNil()
					if err != nil {
						err = msgp.WrapError(err, "IndexColumns", za0002)
						return
					}
					z.IndexColumns[za0002] = nil
				} else {
					if z.IndexColumns[za0002] == nil {
						z.IndexColumns[za0002] = new(RedoColumn)
					}
					err = z.IndexColumns[za0002].DecodeMsg(dc)
					if err != nil {
						err = msgp.WrapError(err, "IndexColumns", za0002)
						return
					}
...
func (z *RedoRowChangedEvent) EncodeMsg(en *msgp.Writer) (err error) {
	...
	for za0002 := range z.IndexColumns {
		if z.IndexColumns[za0002] == nil {
			...
			err = z.IndexColumns[za0002].EncodeMsg(en)
			if err != nil {
				err = msgp.WrapError(err, "IndexColumns", za0002)
				return
			}
...
func (z *RedoRowChangedEvent) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0002 := range z.IndexColumns {
		if z.IndexColumns[za0002] == nil {
			...
			o, err = z.IndexColumns[za0002].MarshalMsg(o)
			if err != nil {
				err = msgp.WrapError(err, "IndexColumns", za0002)
				return
			}
		...
		case "indexColumns":
			...
			for za0002 := range z.IndexColumns {
				if msgp.IsNil(bts) {
					...
					bts, err = z.IndexColumns[za0002].UnmarshalMsg(bts)
					if err != nil {
						err = msgp.WrapError(err, "IndexColumns", za0002)
						return
					}
...
func (z *RedoRowChangedEvent) Msgsize() (s int) {
	...
	for za0002 := range z.IndexColumns {
		if z.IndexColumns[za0002] == nil {
			...
			s += z.IndexColumns[za0002].Msgsize()
		}
	}
	return
}
...
func (z *RowChangedEvent) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "commit-startTs"
	err = en.Append(0xae, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x2d, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54, 0x73)
	if err != nil {
		return
	}
	err = en.WriteUint64(z.CommitTs)
...
func (z *RowChangedEvent) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendUint64(o, z.StartTs)
	// string "commit-startTs"
	o = append(o, 0xae, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x2d, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54, 0x73)
	o = msgp.AppendUint64(o, z.CommitTs)
	// string "table"
...
func (z *RowChangedEvent) Msgsize() (s int) {
	s = 1 + 8 + msgp.Uint64Size + 15 + msgp.Uint64Size + 6
	if z.Table == nil {
		s += msgp.NilSize
	} else {
		s += z.Table.Msgsize()
