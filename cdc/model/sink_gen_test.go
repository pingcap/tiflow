...
func TestMarshalUnmarshalRowChangedDatums(t *testing.T) {
	v := RowChangedDatums{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgRowChangedDatums(b *testing.B) {
	v := RowChangedDatums{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgRowChangedDatums(b *testing.B) {
	v := RowChangedDatums{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalRowChangedDatums(b *testing.B) {
	v := RowChangedDatums{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeRowChangedDatums(t *testing.T) {
	v := RowChangedDatums{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeRowChangedDatums Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeRowChangedDatums(b *testing.B) {
	v := RowChangedDatums{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeRowChangedDatums(b *testing.B) {
	v := RowChangedDatums{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
