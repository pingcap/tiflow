...
func ForwardToOwnerMiddleware(p capture.CaptureInfoProvider) gin.HandlerFunc {
...
func CheckServerReadyMiddleware(capture capture.CaptureInfoProvider) gin.HandlerFunc {
	return func(c *gin.Context) {
		if capture.IsReady() {
			c.Next()
		} else {
