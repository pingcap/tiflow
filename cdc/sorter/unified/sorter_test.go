...
func TestSorterBasic(t *testing.T) {
	...
	require.Nil(t, err)
	sorter, err := NewUnifiedSorter(conf.Sorter.SortDir, model.DefaultNamespaceChangeFeedID("test-cf"), "test", 0)
	require.Nil(t, err)
...
func TestSorterCancel(t *testing.T) {
	...
	err := os.MkdirAll(conf.Sorter.SortDir, 0o755)
	require.Nil(t, err)
	sorter, err := NewUnifiedSorter(conf.Sorter.SortDir, model.DefaultNamespaceChangeFeedID("cf-1"), "test", 0)
	require.Nil(t, err)
...
func TestSortClosedAddEntry(t *testing.T) {
	...
	sorter, err := NewUnifiedSorter(t.TempDir(), model.DefaultNamespaceChangeFeedID("cf-1"), "test", 0)
	require.Nil(t, err)
...
func TestUnifiedSorterFileLockConflict(t *testing.T) {
	...
	_, err = NewUnifiedSorter(dir, model.DefaultNamespaceChangeFeedID("cf-1"), "test", 0)
