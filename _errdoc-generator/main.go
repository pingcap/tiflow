...
func main() {
	...
	allErrors = append(allErrors, pkg_errors.ErrConsistentLevel)
	allErrors = append(allErrors, pkg_errors.ErrConsistentStorage)
	allErrors = append(allErrors, pkg_errors.ErrInvalidS3URI)
