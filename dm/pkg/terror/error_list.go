...
var (
	...
	ErrInvalidConversion         = New(codeInvalidConversion, ClassFunctional, ScopeUpstream, LevelMedium, "invalidly converting %d (uint32 in the upper-half of uint32 values) to int32", "Please check the value of %d and make sure its conversion to uint32 is valid.")
