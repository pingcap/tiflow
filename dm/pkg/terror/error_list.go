...
var (
	...
	ErrSchedulerRequireRunningTaskInSyncUnit = New(codeSchedulerRequireRunningTaskInSyncUnit, ClassScheduler, ScopeInternal, LevelHigh, "transfer with running tasks %v on source %s should in sync unit", "Please use `pause-task [-s source ...] task` to pause them first.")
