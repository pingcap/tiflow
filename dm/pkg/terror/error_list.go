...
var (
	...
	ErrConfigSecretKeyPath                      = New(codeConfigSecretKeyPath, ClassConfig, ScopeInternal, LevelHigh, "invalid secret key path or content", "Please check whether the path is valid, and has required permission to read the file, and the key is correct.")
