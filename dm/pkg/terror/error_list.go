...
var (
	...
	ErrSchedulerSourceCfgUpdate              = New(codeSchedulerSourceCfgUpdate, ClassScheduler, ScopeInternal, LevelLow, "source with name %s can only update when no running tasks for now", "")
