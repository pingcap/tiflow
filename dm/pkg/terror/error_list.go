...
var (
	...
	ErrConfigSecretKeyPath                      = New(codeConfigSecretKeyPath, ClassConfig, ScopeInternal, LevelHigh, "invalid secret key path", "Please check whether the path is valid, and has required permission to read the file, and the key is correct.")
