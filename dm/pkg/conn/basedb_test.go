...
func (t *testBaseDBSuite) TestFailDBPing(c *C) {
	c.Assert(failpoint.Enable("github.com/pingcap/ticdc/dm/pkg/conn/failDBPing", "return"), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/pingcap/ticdc/dm/pkg/conn/failDBPing")
