...
func DeleteInfosOperationsSchemaColumn(cli *clientv3.Client, infos []Info, ops []Operation, task, downSchema, downTable string) (int64, bool, error) {
	...
	opsDel = append(opsDel, deleteDroppedColumnsByLockOp(utils.GenDDLLockID(task, downSchema, downTable)))
