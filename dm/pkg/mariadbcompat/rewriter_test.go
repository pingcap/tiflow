...
func TestRewriteSQLDefaultRules(t *testing.T) {
  ...
  KEY idx_v (v)
	...
	output, err := rewriter.RewriteSQL(input)
...
func TestRewriteSQLNonStrictReturnsOriginal(t *testing.T) {
...
func TestRewriteSQLTrailingCommaAndVersionMacros(t *testing.T) {
	rewriter := NewRewriter(nil)
...
func TestRewriteSQLPlannedRules(t *testing.T) {
	rewriter := NewRewriter(nil)
...
func TestRewriteSQLConstraintCleanup(t *testing.T) {
	rewriter := NewRewriter(nil)
	input := `CREATE TABLE t (
  id INT,
  ref_id INT,
...
func TestRewriteSQLSystemVersioningCleanup(t *testing.T) {
	rewriter := NewRewriter(nil)
	input := `CREATE TABLE t (
  id INT,
...
func TestRewriteSQLSequenceAndCreateOrReplaceCleanup(t *testing.T) {
	rewriter := NewRewriter(nil)
...
func TestRewriteSQLColumnAttributesAndIndexOptions(t *testing.T) {
	rewriter := NewRewriter(nil)
	input := `CREATE TABLE t (
  a INT INVISIBLE,
  b INT COMPRESSED,
...
func TestRewriteSQLFulltextSpatialEngineCollationIgnored(t *testing.T) {
	rewriter := NewRewriter(nil)
