...
func TestCollectDirFilesAndRemove(t *testing.T) {
	...
	s.s3.EXPECT().
		...
		DoAndReturn(func(_ context.Context, input *s3.ListObjectsV2Input, optFns ...func(*s3.Options)) (*s3.ListObjectsV2Output, error) {
...
func TestRemoveAll(t *testing.T) {
	...
	secondCall := s.s3.EXPECT().
		...
		DoAndReturn(func(_ context.Context, input *s3.DeleteObjectInput, optFns ...func(*s3.Options)) (*s3.DeleteObjectOutput, error) {
			require.Equal(t, "bucket", aws.ToString(input.Bucket))
...
func TestIsNotExistError(t *testing.T) {
	...
	s.s3.EXPECT().
		...
		Return(nil, awserr.New(s3v1.ErrCodeNoSuchKey, "no such key", nil))
