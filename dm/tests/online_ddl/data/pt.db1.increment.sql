...
alter table pt_t1 add column age int after name;
alter table pt_t2 add column age int after name;
...
alter table pt_t2 add column info_json json GENERATED ALWAYS AS (`info`) VIRTUAL after name;
...
alter table pt_t1 add column info_json json GENERATED ALWAYS AS (`info`) VIRTUAL after name;
