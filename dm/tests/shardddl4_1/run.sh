...
function DM_155_CASE {
	...
	run_sql_source1 "alter table ${shardddl1}.${tb1} add column e int not null;"
	random_restart 3
	run_sql_source1 "insert into ${shardddl1}.${tb1} values(10,10,10,10);"
	run_sql_source2 "insert into ${shardddl1}.${tb1} values(11,11,11);"
	run_sql_source2 "insert into ${shardddl1}.${tb2} values(12,12,12);"
	...
	random_restart 3
	run_sql_source1 "insert into ${shardddl1}.${tb1} values(13,13,13,13);"
	...
	run_sql_source2 "alter table ${shardddl1}.${tb1} add column e int not null;"
	random_restart 3
	run_sql_source1 "insert into ${shardddl1}.${tb1} values(19,19,19,19);"
	run_sql_source2 "insert into ${shardddl1}.${tb1} values(20,20,20,20);"
	run_sql_source2 "insert into ${shardddl1}.${tb2} values(21,21,21);"

	run_sql_source2 "alter table ${shardddl1}.${tb2} change c b int;"
	random_restart 3
	run_sql_source1 "insert into ${shardddl1}.${tb1} values(22,22,22,22);"
	...
	run_sql_source2 "alter table ${shardddl1}.${tb2} add column e int not null;"
	random_restart 3
	run_sql_source1 "insert into ${shardddl1}.${tb1} values(28,28,28,28);"
