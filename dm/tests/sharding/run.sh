...
function run() {
	...
	sed "s/sharding1\"#pattern1/sharding[1-2]\"/g" $WORK_DIR/diff_config.toml | sed "s/sharding2\"#pattern1/sharding[1-2]\"/g" $WORK_DIR/diff_config.toml > $WORK_DIR/diff_config_2.toml
