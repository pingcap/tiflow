...
alter table t1 add column info_json json GENERATED ALWAYS AS (`info`) VIRTUAL after name;
alter table t1 add column id_gen int as (uid + 1) after name;
alter table t2 add column id_gen int as (uid + 1) after name;
...
-- test ZERO_DATE
alter table t2 add column create_by DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' after name;
...
alter table t1 add column create_by DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' after name;
