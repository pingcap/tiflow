...
function run() {
	...
	run_sql_tidb "CREATE TABLE dmctl.t_target(id bigint, b int, c varchar(20), d varchar(10), c_table varchar(255), c_source varchar(255), primary key id(id, c_table, c_source), unique key b(b));"
