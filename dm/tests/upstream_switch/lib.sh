...
function install_sync_diff() {
	curl https://download.pingcap.org/tidb-community-toolkit-v5.3.0-linux-amd64.tar.gz | tar xz
	mkdir -p bin
	mv tidb-community-toolkit-v5.3.0-linux-amd64/bin/sync_diff_inspector bin/
}
