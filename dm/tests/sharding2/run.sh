...
function run() {
	...
	export GO_FAILPOINTS='github.com/pingcap/ticdc/dm/syncer/ExitAfterDDLBeforeFlush=return(true)'
	...
	export GO_FAILPOINTS='github.com/pingcap/ticdc/dm/relay/writer/MockRecoverRelayWriter=return(true)'
