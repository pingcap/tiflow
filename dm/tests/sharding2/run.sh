...
function run() {
	...
	export GO_FAILPOINTS='github.com/pingcap/tiflow/dm/syncer/ExitAfterDDLBeforeFlush=return(true)'
	...
	export GO_FAILPOINTS='github.com/pingcap/tiflow/dm/relay/writer/MockRecoverRelayWriter=return(true)'
