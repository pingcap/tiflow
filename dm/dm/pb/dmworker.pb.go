...
type SubTaskStatus struct {
	...
	Validation *ValidationBriefStatus `protobuf:"bytes,11,opt,name=validation,proto3" json:"validation,omitempty"`
}
...
func (m *SubTaskStatus) GetValidation() *ValidationBriefStatus {
	if m != nil {
		return m.Validation
	}
	return nil
...
type ValidationBriefStatus struct {
	Mode   string           `protobuf:"bytes,1,opt,name=mode,proto3" json:"mode,omitempty"`
	Status Stage            `protobuf:"varint,2,opt,name=status,proto3,enum=pb.Stage" json:"status,omitempty"`
	Stats  *ValidationStats `protobuf:"bytes,3,opt,name=stats,proto3" json:"stats,omitempty"`
}

func (m *ValidationBriefStatus) Reset()         { *m = ValidationBriefStatus{} }
func (m *ValidationBriefStatus) String() string { return proto.CompactTextString(m) }
func (*ValidationBriefStatus) ProtoMessage()    {}
func (*ValidationBriefStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_51a1b9e17fd67b10, []int{11}
}
func (m *ValidationBriefStatus) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidationBriefStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidationBriefStatus.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidationBriefStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidationBriefStatus.Merge(m, src)
}
func (m *ValidationBriefStatus) XXX_Size() int {
	return m.Size()
}
func (m *ValidationBriefStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidationBriefStatus.DiscardUnknown(m)
}

var xxx_messageInfo_ValidationBriefStatus proto.InternalMessageInfo

func (m *ValidationBriefStatus) GetMode() string {
	if m != nil {
		return m.Mode
	}
	return ""
...
func (m *ValidationBriefStatus) GetStatus() Stage {
	if m != nil {
		return m.Status
	}
	return Stage_InvalidStage
...
func (m *ValidationBriefStatus) GetStats() *ValidationStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
type ValidationStats struct {
	ProcessedRows string `protobuf:"bytes,1,opt,name=ProcessedRows,proto3" json:"ProcessedRows,omitempty"`
	PendingRows   string `protobuf:"bytes,2,opt,name=PendingRows,proto3" json:"PendingRows,omitempty"`
	ErrorRows     string `protobuf:"bytes,3,opt,name=ErrorRows,proto3" json:"ErrorRows,omitempty"`
}

func (m *ValidationStats) Reset()         { *m = ValidationStats{} }
func (m *ValidationStats) String() string { return proto.CompactTextString(m) }
func (*ValidationStats) ProtoMessage()    {}
func (*ValidationStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_51a1b9e17fd67b10, []int{12}
}
func (m *ValidationStats) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidationStats) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidationStats.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidationStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidationStats.Merge(m, src)
}
func (m *ValidationStats) XXX_Size() int {
	return m.Size()
}
func (m *ValidationStats) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidationStats.DiscardUnknown(m)
}

var xxx_messageInfo_ValidationStats proto.InternalMessageInfo

func (m *ValidationStats) GetProcessedRows() string {
	if m != nil {
...
func (m *ValidationStats) GetPendingRows() string {
	if m != nil {
...
func (m *ValidationStats) GetErrorRows() string {
	if m != nil {
		return m.ErrorRows
	}
	return ""
...
type ValidationStatus struct {
	...
	Stage               Stage          `protobuf:"varint,3,opt,name=stage,proto3,enum=pb.Stage" json:"stage,omitempty"`
	ValidatorBinlog     string         `protobuf:"bytes,4,opt,name=validatorBinlog,proto3" json:"validatorBinlog,omitempty"`
	ValidatorBinlogGtid string         `protobuf:"bytes,5,opt,name=validatorBinlogGtid,proto3" json:"validatorBinlogGtid,omitempty"`
	Result              *ProcessResult `protobuf:"bytes,6,opt,name=result,proto3" json:"result,omitempty"`
	ProcessedRowsStatus string         `protobuf:"bytes,7,opt,name=processedRowsStatus,proto3" json:"processedRowsStatus,omitempty"`
	PendingRowsStatus   string         `protobuf:"bytes,8,opt,name=pendingRowsStatus,proto3" json:"pendingRowsStatus,omitempty"`
	AllErrorRowsStatus  string         `protobuf:"bytes,9,opt,name=allErrorRowsStatus,proto3" json:"allErrorRowsStatus,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*ValidationBriefStatus)(nil), "pb.ValidationBriefStatus")
	proto.RegisterType((*ValidationStats)(nil), "pb.ValidationStats")
...
var fileDescriptor_51a1b9e17fd67b10 = []byte{
	...
	,
}
...
func (m *ValidationBriefStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidationBriefStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidationBriefStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ValidationStats) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidationStats) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidationStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ErrorRows) > 0 {
		i -= len(m.ErrorRows)
		copy(dAtA[i:], m.ErrorRows)
		i = encodeVarintDmworker(dAtA, i, uint64(len(m.ErrorRows)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.PendingRows) > 0 {
		i -= len(m.PendingRows)
		copy(dAtA[i:], m.PendingRows)
		i = encodeVarintDmworker(dAtA, i, uint64(len(m.PendingRows)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ProcessedRows) > 0 {
		i -= len(m.ProcessedRows)
		copy(dAtA[i:], m.ProcessedRows)
		i = encodeVarintDmworker(dAtA, i, uint64(len(m.ProcessedRows)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ValidationBriefStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ValidationStats) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.ProcessedRows)
	if l > 0 {
		n += 1 + l + sovDmworker(uint64(l))
	}
	l = len(m.PendingRows)
...
func (m *SubTaskStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if m.Validation == nil {
				m.Validation = &ValidationBriefStatus{}
			}
...
func (m *ValidationBriefStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidationBriefStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidationBriefStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ValidationStats) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidationStats: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidationStats: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.ProcessedRows = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingRows", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PendingRows = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ErrorRows", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ErrorRows = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDmworker(dAtA[iNdEx:])
