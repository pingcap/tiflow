...
var file_engine_proto_test_proto_goTypes = []any{
...
func file_engine_proto_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_engine_proto_test_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_engine_proto_test_proto_msgTypes[1].Exporter = func(v any, i int) any {
