...
type QueryJobRequest struct {
	...
	Project *ProjectInfo `protobuf:"bytes,2,opt,name=project,proto3" json:"project,omitempty"`
}
...
func (m *QueryJobRequest) GetProject() *ProjectInfo {
	if m != nil {
		return m.Project
	}
	return nil
...
func (m *CancelJobRequest) GetProject() *ProjectInfo {
	if m != nil {
		return m.Project
	}
	return nil
...
func (m *PauseJobRequest) GetProject() *ProjectInfo {
	if m != nil {
		return m.Project
	}
	return nil
