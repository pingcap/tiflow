...
func (m *ErrorV2) GetStackTrace() string {
	if m != nil {
		return m.StackTrace
	}
	return ""
...
var fileDescriptor_225f1ee3bd42a258 = []byte{
	...
	0x4b, 0x2d, 0x48, 0x52, 0x8a, 0xe0, 0x62, 0x77, 0x05, 0x49, 0x85, 0x19, 0x09, 0x09, 0x71, 0xb1,
	...
	0xae, 0x90, 0x3c, 0x17, 0x77, 0x71, 0x49, 0x62, 0x72, 0x76, 0x7c, 0x49, 0x51, 0x62, 0x72, 0xaa,
	0x04, 0x33, 0x58, 0x13, 0x17, 0x58, 0x28, 0x04, 0x24, 0xe2, 0x24, 0x71, 0xe2, 0x91, 0x1c, 0xe3,
	0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c,
	0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x49, 0x6c, 0x60, 0x47, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0xb7, 0x35, 0x2b, 0x06, 0x95, 0x00, 0x00, 0x00,
}
...
func (m *ErrorV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StackTrace) > 0 {
		...
		i = encodeVarintErrorv2(dAtA, i, uint64(len(m.StackTrace)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Details) > 0 {
