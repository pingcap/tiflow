...
// Defines values for OperateTaskRequestOp.
const (
	OperateTaskRequestOpPause OperateTaskRequestOp = "pause"

	OperateTaskRequestOpResume OperateTaskRequestOp = "resume"
)
...
// OperateTaskRequest defines model for OperateTaskRequest.
type OperateTaskRequest struct {
	Op OperateTaskRequestOp `json:"op"`
}

// OperateTaskRequestOp defines model for OperateTaskRequest.Op.
type OperateTaskRequestOp string
...
// DMAPIOperateTaskJSONBody defines parameters for DMAPIOperateTask.
type DMAPIOperateTaskJSONBody OperateTaskRequest
...
// DMAPIOperateTaskJSONRequestBody defines body for DMAPIOperateTask for application/json ContentType.
type DMAPIOperateTaskJSONRequestBody DMAPIOperateTaskJSONBody
