...
=======
	mock.ExpectExec(regexp.QuoteMeta("CREATE TABLE `resource_meta` (`seq_id` bigint unsigned AUTO_INCREMENT,`created_at` datetime(3) NULL,`updated_at` datetime(3) NULL," +
		"`project_id` varchar(128) not null,`tenant_id` varchar(128) not null,`id` varchar(128) not null,`job_id` varchar(128) not null,`worker_id` varchar(128) not null,`executor_id` varchar(128) not null," +
