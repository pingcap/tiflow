...
func (m *MockKVClient) Delete(arg0 context.Context, arg1 string, arg2 ...common.OpOption) (*common.DeleteResponse, common.Error) {
	m.ctrl.T.Helper()
...
func (m *MockKVClient) Get(arg0 context.Context, arg1 string, arg2 ...common.OpOption) (*common.GetResponse, common.Error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*common.GetResponse)
	ret1, _ := ret[1].(common.Error)
	return ret0, ret1
}
...
func (m *MockKVClient) Put(arg0 context.Context, arg1, arg2 string) (*common.PutResponse, common.Error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Put", arg0, arg1, arg2)
	ret0, _ := ret[0].(*common.PutResponse)
	ret1, _ := ret[1].(common.Error)
	return ret0, ret1
}
...
func (m *MockKVClient) Txn(arg0 context.Context) common.Txn {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Txn", arg0)
	ret0, _ := ret[0].(common.Txn)
	return ret0
}
