...
// Source: github.com/pingcap/tiflow/engine/pb (interfaces: ExecutorClient)
...
func (m *MockExecutorClient) ConfirmDispatchTask(arg0 context.Context, arg1 *pb.ConfirmDispatchTaskRequest, arg2 ...grpc.CallOption) (*pb.ConfirmDispatchTaskResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*pb.ConfirmDispatchTaskResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockExecutorClient) PreDispatchTask(arg0 context.Context, arg1 *pb.PreDispatchTaskRequest, arg2 ...grpc.CallOption) (*pb.PreDispatchTaskResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*pb.PreDispatchTaskResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
