...
create database `sync_collation_increment2` character set utf8mb4;
use `sync_collation_increment2`;
create table t1 (id int, name varchar(20), primary key(`id`)) character set utf8mb4;
insert into t1 (id, name) values (1, 'Aa'), (2, 'aA');
create table t2 (id int, name varchar(20) character set utf8mb4, primary key(`id`)) character set latin1 collate latin1_bin;
