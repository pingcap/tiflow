...
CREATE TABLE t0 (id bigint primary key clustered , a int);
...
create table t6 (id int primary key clustered , a int) PARTITION BY RANGE ( id ) ( PARTITION p0 VALUES LESS THAN (6),PARTITION p1 VALUES LESS THAN (11),PARTITION p2 VALUES LESS THAN (21));
