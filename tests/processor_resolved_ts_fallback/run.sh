...
function run() {
    ...
    run_sql "CREATE table processor_resolved_ts_fallback.t1(id int primary key clustered auto_increment, val int);" ${UP_TIDB_HOST} ${UP_TIDB_PORT}
    ...
    run_sql "CREATE table processor_resolved_ts_fallback.t2(id int primary key clustered auto_increment, val int);" ${UP_TIDB_HOST} ${UP_TIDB_PORT}
    run_sql "CREATE table processor_resolved_ts_fallback.t3(id int primary key clustered auto_increment, val int);" ${UP_TIDB_HOST} ${UP_TIDB_PORT}
