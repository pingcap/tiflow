...
function run() {
    ...
    run_sql "CREATE table processor_stop_delay.t (id int primary key auto clustered _increment, t datetime DEFAULT CURRENT_TIMESTAMP)" ${UP_TIDB_HOST} ${UP_TIDB_PORT}
