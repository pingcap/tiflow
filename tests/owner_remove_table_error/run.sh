...
function run() {
    ...
    export GO_FAILPOINTS='github.com/pingcap/ticdc/cdc/OwnerRemoveTableError=return(true);github.com/pingcap/ticdc/cdc/ProcessorPanicWhenDyingTableAdded=return(true)'
