...
function prepare() {
	...
	case $SINK_TYPE in
	kafka) SINK_URI="kafka://127.0.0.1:9092/$TOPIC_NAME?protocol=canal-json&enable-tidb-extension=true&partition-num=3&kafka-version=${KAFKA_VERSION}&max-message-bytes=10485760" ;;
	...
	*) SINK_URI="mysql://normal:123456@127.0.0.1:3306/" ;;
	...
	case $SINK_TYPE in
	kafka) run_kafka_consumer $WORK_DIR "kafka://127.0.0.1:9092/$TOPIC_NAME?protocol=canal-json&enable-tidb-extension=true&partition-num=3&version=${KAFKA_VERSION}&max-message-bytes=10485760" ;;
