...
function run() {
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/OwnerRemoveTableError=1*return(true)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner/OwnerRemoveTableError=1*return(true)' # new owner
