...
# 5. kill the drained capture, and deploy 2 new captures, now 3 captures in total
# 6. drain one capture, and kill the another non-owner capture
# 7. another capture goes online, kill the owner capture

# todo: add sysbench / go-tpc workload support
