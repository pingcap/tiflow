...
run_sql "SET GLOBAL time_zone = 'Asia/Shanghai';" ${UP_TIDB_HOST} ${UP_TIDB_PORT}
mysql -h 127.0.0.1 -P 3310 -u debezium --password dbz --default-character-set utf8mb4 -E -e "SET GLOBAL time_zone = 'Asia/Shanghai';" >>"$OUT_DIR/sql_res.$TEST_NAME.txt"
