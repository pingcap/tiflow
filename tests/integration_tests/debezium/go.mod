...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20240910154453-b242104f8d31 // indirect
	...
	github.com/tikv/client-go/v2 v2.0.8-0.20240911041506-e7894a7b27ba // indirect
	github.com/tikv/pd/client v0.0.0-20240914083230-71f6f96816e9 // indirect
