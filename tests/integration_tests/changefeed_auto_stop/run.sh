...
function run() {
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/ProcessorSyncResolvedError=1*return(true);github.com/pingcap/tiflow/cdc/ProcessorUpdatePositionDelaying=return(true)' # old processor
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/processor/pipeline/ProcessorSyncResolvedError=1*return(true);github.com/pingcap/tiflow/cdc/processor/ProcessorUpdatePositionDelaying=sleep(1000)' # new processor
