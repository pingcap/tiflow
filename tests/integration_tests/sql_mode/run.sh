...
# insert into t20 (id, a, c) values(1,1234567890123, 'ab\\c');
...
run_sql "use test; \
         create table t1(id bigint primary key, a text, b text as ((regexp_replace(a, "^[1-9]\d{9,29}$", "aaaaa"))), c text); \
         insert into t1 (id, a, c) values(1,123456, 'ab\\\\c'); \
         insert into t1 (id, a, c) values(1,1234567890123, 'ab\\c');" ${UP_TIDB_HOST} ${UP_TIDB_PORT}
