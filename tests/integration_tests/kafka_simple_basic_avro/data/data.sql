...
ALTER TABLE TBL1 ADD COLUMN v1 INTEGER DEFAULT 0;
INSERT INTO TBL1 (id) VALUES(2);
UPDATE TBL1 SET id = 3, v1 = 10 WHERE id = 1;
UPDATE TBL1 SET v1 = 11 WHERE id = 2;
INSERT INTO TBL1 (id, v1) VALUES(1000, 1000);
UPDATE TBL1 SET v1 = 1001 WHERE id = 1000;
