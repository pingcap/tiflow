...
function test_owner_retryable_error() {
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/capture-campaign-compacted-error=1*return(true)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/capture/capture-campaign-compacted-error=1*return(true)' # new owner
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner-run-with-error=1*return(true);github.com/pingcap/tiflow/cdc/capture-resign-failed=1*return(true)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner/owner-run-with-error=1*return(true);github.com/pingcap/tiflow/cdc/capture/capture-resign-failed=1*return(true)' # new owner
...
function test_gap_between_watch_capture() {
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/sleep-before-watch-capture=1*sleep(6000)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner/sleep-in-owner-tick=1*sleep(6000)' # new owner
