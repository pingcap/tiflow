...
function run() {
	...
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/sink/mysql/SinkFlushDMLPanic=return(true);github.com/pingcap/tiflow/cdc/sinkv2/eventsink/mq/dmlproducer/SinkFlushDMLPanic=return(true)'
