...
function run() {
	...
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/sinkv2/dmlsink/txn/mysql/MySQLSinkExecDMLError=return(true);github.com/pingcap/tiflow/cdc/sinkv2/dmlsink/mq/dmlproducer/KafkaSinkAsyncSendError=return(true)'
