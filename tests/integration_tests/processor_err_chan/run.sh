...
function run() {
	...
	*) SINK_URI="mysql://normal:123456@127.0.0.1:3306/?max-txn-row=1" ;;
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/ProcessorAddTableError=1*return(true)' # old processor
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/processor/pipeline/ProcessorAddTableError=1*return(true)' # new processor
