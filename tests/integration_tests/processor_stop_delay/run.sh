...
function run() {
	...
	*) SINK_URI="mysql://normal:123456@127.0.0.1:3306/?max-txn-row=1" ;;
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/processorStopDelay=1*sleep(10000)' # old processor
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/processor/processorStopDelay=1*sleep(10000)' # new processor
