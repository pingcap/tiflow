...
function run() {
	...
	*) SINK_URI="mysql://normal:123456@127.0.0.1:3306/?max-txn-row=1" ;;
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/captureHandleTaskDelay=sleep(2000)' # old processor
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/processor/processorManagerHandleNewChangefeedDelay=sleep(2000)' # new processor
