...
groups=(
	...
	["G07"]='clustered_index multi_tables_ddl big_txn_sarama'
	["G08"]='bank multi_source kafka_sink_error_resume'
	["G09"]='capture_suicide_while_balance_table'
	["G10"]='multi_topics_sarama consistent_replicate_storage_s3 sink_retry'
	...
	["G19"]='kafka_big_messages_sarama multi_tables_ddl_sarama split_region availability'
