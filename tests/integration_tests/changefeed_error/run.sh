...
function run() {
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/NewChangefeedNoRetryError=1*return(true)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner/NewChangefeedNoRetryError=1*return(true)' # new owner
	...
	*) SINK_URI="mysql://normal:123456@127.0.0.1:3306/?max-txn-row=1" ;;
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/NewChangefeedRetryError=return(true)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner/NewChangefeedRetryError=return(true)' # new owner
	kill $capture_pid
	...
	# export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/InjectChangefeedDDLError=return(true)' # old owner
	export GO_FAILPOINTS='github.com/pingcap/tiflow/cdc/owner/InjectChangefeedDDLError=return(true)' # new owner
	run_cdc_server --workdir $WORK_DIR --binary $CDC_BINARY
