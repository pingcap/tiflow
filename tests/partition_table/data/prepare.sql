...
create table t (a int, primary key (a) clustered ) partition by hash(a) partitions 5;
...
create table t1 (a int primary key clustered ) PARTITION BY RANGE ( a ) ( PARTITION p0 VALUES LESS THAN (6),PARTITION p1 VALUES LESS THAN (11),PARTITION p2 VALUES LESS THAN (21));
