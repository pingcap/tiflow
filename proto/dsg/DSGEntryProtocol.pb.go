...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{0}
}
...
func (EventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{1}
}
...
func (DBType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{2}
}
...
type Entry struct {
	...
	//*打散后的事件类型*
	EntryType *EntryType `protobuf:"varint,7,opt,name=entryType,enum=EntryType,def=3" json:"entryType,omitempty"`
	//*传输的二进制数组*
...
type Header struct {
	...
	//*数据变更类型*
	EventType            *EventType `protobuf:"varint,3,opt,name=eventType,enum=EventType,def=3" json:"eventType,omitempty"`
...
func (*RowData) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{3}
}
...
func (*RowDataList) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{4}
}
...
func (*TransactionBegin) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{5}
}
...
type TableInfo struct {
	...
	//* 变更数据的来源*
	SourceType           *DBType        `protobuf:"varint,2,opt,name=sourceType,enum=DBType,def=2" json:"sourceType,omitempty"`
...
func (*TableInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{6}
}
...
func (*PrimaryInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{7}
}
...
func (*ColumnInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{8}
}
...
func (*IndexInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{9}
}
...
func (*TransactionEnd) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{10}
}
...
func (*Pair) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c53722c9d0378f, []int{11}
}
...
func init() {
	proto.RegisterEnum("EntryType", EntryType_name, EntryType_value)
	...
	proto.RegisterType((*RowData)(nil), "RowData")
	proto.RegisterType((*RowDataList)(nil), "RowDataList")
	proto.RegisterType((*TransactionBegin)(nil), "TransactionBegin")
	proto.RegisterType((*TableInfo)(nil), "TableInfo")
	proto.RegisterType((*PrimaryInfo)(nil), "PrimaryInfo")
	proto.RegisterType((*ColumnInfo)(nil), "ColumnInfo")
	proto.RegisterType((*IndexInfo)(nil), "IndexInfo")
	proto.RegisterType((*TransactionEnd)(nil), "TransactionEnd")
	proto.RegisterType((*Pair)(nil), "Pair")
}

func init() { proto.RegisterFile("DSGEntryProtocol.proto", fileDescriptor_92c53722c9d0378f) }

var fileDescriptor_92c53722c9d0378f = []byte{
	...
	,
}
...
func (m *Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ThisRowNum != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ThisRowNum))
		i--
		dAtA[i] = 0x58
	}
	if m.TheLastNum != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.TheLastNum))
		i--
		dAtA[i] = 0x50
	}
	if m.ErrorMsg != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ErrorMsg)))
		i--
		dAtA[i] = 0x4a
	}
	if m.StoreValue != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(m.StoreValue)))
		i--
		dAtA[i] = 0x42
	}
	if m.EntryType != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.EntryType))
		i--
		dAtA[i] = 0x38
	}
	if m.Header != nil {
		{
			...
			i -= size
			i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x32
	}
	if m.BatchCountNo != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.BatchCountNo))
		i--
		dAtA[i] = 0x28
	}
	if m.BatchID != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.BatchID)))
		i--
		dAtA[i] = 0x22
	}
	if m.StatFlag != nil {
	...
	if m.FlowID != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.FlowID)))
		i--
		dAtA[i] = 0x12
	}
	if m.UserID != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.UserID)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColsNum != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ColsNum))
		i--
		dAtA[i] = 0x48
	}
	if m.RowsNum != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.RowsNum))
		i--
		dAtA[i] = 0x40
	}
	if m.OperType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.OperType)))
		i--
		dAtA[i] = 0x3a
	}
	if m.ObjnInfo != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ObjnInfo)))
		i--
		dAtA[i] = 0x32
	}
	if m.ScnInfo != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ScnInfo)))
		i--
		dAtA[i] = 0x2a
	}
	if m.FileNo != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.FileNo)))
		i--
		dAtA[i] = 0x22
	}
	if m.EventType != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.EventType))
		i--
		dAtA[i] = 0x18
	}
	if m.TableName != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.TableName)))
		i--
		dAtA[i] = 0x12
	}
	if m.SchemaName != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.SchemaName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Column) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColValue != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColValue)))
		i--
		dAtA[i] = 0x32
	}
	if m.ColValueLen != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ColValueLen))
		i--
		dAtA[i] = 0x28
	}
	if m.ColFlags != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ColFlags))
		i--
		dAtA[i] = 0x20
	}
	if m.ColName != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColName)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ColType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColType)))
		i--
		dAtA[i] = 0x12
	}
	if m.ColNo != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ColNo))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *RowData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColValueLens != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ColValueLens))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TransactionBegin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ThreadId != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ThreadId))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Props) > 0 {
	...
	if m.TransactionId != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.TransactionId)))
		i--
		dAtA[i] = 0x12
	}
	if m.ExecuteTime != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ExecuteTime))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TableInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TableDescription != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.TableDescription)))
		i--
		dAtA[i] = 0x4a
	}
	if m.CreateTime != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.CreateTime)))
		i--
		dAtA[i] = 0x42
	}
	if m.TableCharacterSet != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.TableCharacterSet)))
		i--
		dAtA[i] = 0x3a
	}
	if m.ObjnNo != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.ObjnNo))
		i--
		dAtA[i] = 0x30
	}
	if m.TableID != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.TableID)))
		i--
		dAtA[i] = 0x2a
	}
	if m.TableName != nil {
	...
	if m.SourceType != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.SourceType))
		i--
		dAtA[i] = 0x10
	}
	if m.Version != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.Version))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PrimaryInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColumnName != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColumnName)))
		i--
		dAtA[i] = 0x12
	}
	if m.ColumnNo != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColumnNo)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ColumnInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColDescription != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColDescription)))
		i--
		dAtA[i] = 0x62
	}
	if m.ColEncoding != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColEncoding)))
		i--
		dAtA[i] = 0x5a
	}
	if m.IsNullable != nil {
	...
	if m.OrderNo != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.OrderNo))
		i--
		dAtA[i] = 0x40
	}
	if m.GeneralType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(m.GeneralType)))
		i--
		dAtA[i] = 0x3a
	}
	if m.ColumnType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColumnType)))
		i--
		dAtA[i] = 0x32
	}
	if m.ColJavaType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColJavaType)))
		i--
		dAtA[i] = 0x2a
	}
	if m.DataType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.DataType)))
		i--
		dAtA[i] = 0x22
	}
	if m.DataPrecision != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.DataPrecision)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ColLen != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.ColLen)))
		i--
		dAtA[i] = 0x12
	}
	if m.ColName != nil {
...
func (m *IndexInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IndexComment != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.IndexComment)))
		i--
		dAtA[i] = 0x32
	}
	if m.IndexNo != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.IndexNo))
		i--
		dAtA[i] = 0x28
	}
	if m.UniqueFlag != nil {
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(*m.UniqueFlag))
		i--
		dAtA[i] = 0x20
	}
	if m.IndexType != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.IndexType)))
		i--
		dAtA[i] = 0x1a
	}
	if m.IndexName != nil {
		...
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.IndexName)))
		i--
		dAtA[i] = 0x12
	}
	if m.ColName != nil {
...
func (m *Pair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Value != nil {
		i -= len(*m.Value)
		copy(dAtA[i:], *m.Value)
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.Value)))
		i--
		dAtA[i] = 0x12
	}
	if m.Key != nil {
		i -= len(*m.Key)
		copy(dAtA[i:], *m.Key)
		i = encodeVarintDSGEntryProtocol(dAtA, i, uint64(len(*m.Key)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintDSGEntryProtocol(dAtA []byte, offset int, v uint64) int {
	offset -= sovDSGEntryProtocol(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Entry) Size() (n int) {
	...
	if m.UserID != nil {
		l = len(*m.UserID)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	}
	if m.FlowID != nil {
		l = len(*m.FlowID)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	...
	if m.BatchCountNo != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.BatchCountNo))
	}
	if m.Header != nil {
		l = m.Header.Size()
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	...
	if m.EntryType != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.EntryType))
	}
	if m.StoreValue != nil {
		l = len(m.StoreValue)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	...
	if m.TheLastNum != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.TheLastNum))
	}
	if m.ThisRowNum != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ThisRowNum))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Header) Size() (n int) {
	...
	if m.EventType != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.EventType))
	}
	if m.FileNo != nil {
		l = len(*m.FileNo)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	...
	if m.RowsNum != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.RowsNum))
	}
	if m.ColsNum != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ColsNum))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Column) Size() (n int) {
	...
	_ = l
	if m.ColNo != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ColNo))
	}
	if m.ColType != nil {
		l = len(*m.ColType)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	...
	if m.ColFlags != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ColFlags))
	}
	if m.ColValueLen != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ColValueLen))
	}
	if m.ColValue != nil {
		l = len(*m.ColValue)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
...
func (m *RowData) Size() (n int) {
	...
	_ = l
	if m.ColValueLens != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ColValueLens))
	}
	if len(m.Columns) > 0 {
...
func (m *TransactionBegin) Size() (n int) {
	...
	_ = l
	if m.ExecuteTime != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ExecuteTime))
	}
	if m.TransactionId != nil {
	...
	if m.ThreadId != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ThreadId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TableInfo) Size() (n int) {
	...
	_ = l
	if m.Version != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.Version))
	}
	if m.SourceType != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.SourceType))
	}
	if m.SchemaName != nil {
		l = len(*m.SchemaName)
		n += 1 + l + sovDSGEntryProtocol(uint64(l))
	...
	if m.ObjnNo != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.ObjnNo))
	}
	if m.TableCharacterSet != nil {
...
func (m *ColumnInfo) Size() (n int) {
	...
	if m.OrderNo != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.OrderNo))
	}
	if m.IsPrimaryKey != nil {
		n += 2
	}
...
func (m *IndexInfo) Size() (n int) {
	...
	if m.UniqueFlag != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.UniqueFlag))
	}
	if m.IndexNo != nil {
		n += 1 + sovDSGEntryProtocol(uint64(*m.IndexNo))
	}
	if m.IndexComment != nil {
...
func sovDSGEntryProtocol(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozDSGEntryProtocol(x uint64) (n int) {
	return sovDSGEntryProtocol(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowDSGEntryProtocol
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthDSGEntryProtocol
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipDSGEntryProtocol(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipDSGEntryProtocol(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowDSGEntryProtocol
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthDSGEntryProtocol
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupDSGEntryProtocol
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthDSGEntryProtocol        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowDSGEntryProtocol          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupDSGEntryProtocol = fmt.Errorf("proto: unexpected end of group")
)
