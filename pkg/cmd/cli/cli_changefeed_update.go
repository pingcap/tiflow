...
func (o *updateChangefeedOptions) run(cmd *cobra.Command) error {
	...
	old, err := o.etcdClient.GetChangeFeedInfo(ctx, model.DefaultNamespaceChangeFeedID(o.changefeedID))
	if err != nil {
		return err
	}
	...
	err = o.etcdClient.SaveChangeFeedInfo(ctx, newInfo, model.DefaultNamespaceChangeFeedID(o.changefeedID))
	if err != nil {
		return err
	}
