...
// Reduce will merge two row changes of same row into one row changes, e.g., INSERT{1} + UPDATE{1 -> 2} -> INSERT{2}.
// the receiver will be changed in-place.
...
// Split will split current RowChangeUpdate into two RowChangeDelete and RowChangeInsert one. The behaviour is undefined
// for other types of RowChange.
