...
type EncoderGroup interface {
	...
	AddEvents(ctx context.Context, topic string, partition int32, partitionKey *string,
...
// WrapperMessagePartitionKey if message is nil,
func (p *future) WrapperMessagePartitionKey(message *common.Message) *common.Message {
	message.PartitionKey = p.PartitionKey
	return message
}
