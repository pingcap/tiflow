	...
	mock.ExpectQuery(queryQueryDurationStmt).
		WillReturnRows(
			sqlmock.NewRows(
				...
				AddRow("2023-01-10 16:47:08.283000", "10.2.6.127:11080", "Begin", 0.0018886375591793793).
				AddRow("2023-01-10 16:47:08.283000", "10.2.6.127:11080", "Insert", 0.014228768066070199).
				AddRow("2023-01-10 16:47:08.283000", "10.2.6.127:11080", "Delete", nil).
				AddRow("2023-01-10 16:47:08.283000", "10.2.6.127:11080", "Commit", 0.0004933262664880737),
		)
	...
	mock.ExpectQuery(queryTxnDurationStmt).
		WillReturnRows(
			sqlmock.NewRows(
				...
				AddRow("2023-01-10 16:50:38.153000", "10.2.6.127:11080", "abort", nil).
