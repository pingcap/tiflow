...
func TestCheckSafetyOfStartTs(t *testing.T) {
	...
	require.Error(t, err, "[CDC:ErrStartTsBeforeGC]fail to create changefeed because start-ts 50 is earlier than GC safepoint at 60")
	...
	require.Error(t, err, "[CDC:ErrReachMaxTry]reach maximum try: 9: not pd leader")
