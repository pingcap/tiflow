...
var (
	...
	ErrTableIneligible              = errors.Normalize("some tables are not eligible to replicat(%v), if you want to ignore these table, please set ignore_ineligible_table to true", errors.RFCCodeText("CDC:ErrTableIneligible"))
