...
var (
	...
	ErrProcessorTableCanceled       = errors.Normalize("table has been canceled, table-id is %d. Report a bug if seen externally", errors.RFCCodeText("CDC:ErrProcessorTableCanceled"))
