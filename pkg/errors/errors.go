...
var (
	...
	ErrPeerMessageInjectedServerRestart = errors.Normalize("peer-to-peer message server restarted for the purpose of testing", errors.RFCCodeText("CDC:ErrPeerMessageInjectedServerRestart"))
