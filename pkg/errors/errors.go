...
var (
	...
	ErrUpdateSafepointFailed      = errors.Normalize("updating service safepoint failed. current safepoint is %d, please remove failed changefeed(s)", errors.RFCCodeText("CDC:ErrUpdateSafepointFailed"))
