...
var (
	...
	ErrStartTsBeforeGC              = errors.Normalize("fail to create or maintain changefeed because start-ts %d is earlier than or equal to GC safepoint at %d", errors.RFCCodeText("CDC:ErrStartTsBeforeGC"))
