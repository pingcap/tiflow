...
var (
	...
	ErrTableListenReplicated        = errors.Normalize("A table is replicated by two processor(%s, %s), please report a bug", errors.RFCCodeText("CDC:ErrTableListenReplicated"))
