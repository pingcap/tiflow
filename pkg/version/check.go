...
var (
	...
	maxPDVersion *semver.Version = semver.New("6.1.0-alpha")
	...
	maxTiKVVersion *semver.Version = semver.New("6.1.0-alpha")
	...
	maxTiCDCVersion *semver.Version = semver.New("6.1.0-alpha")
