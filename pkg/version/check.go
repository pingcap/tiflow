...
var (
	...
	// TODO bump 5.1.0-alpha once PD releases.
	...
	maxPDVersion *semver.Version = semver.New("5.3.0-alpha")

	// MinTiKVVersion is the version of the minimal compatible TiKV.
	// TODO bump 5.1.0-alpha once TiKV releases.
