...
var (
	...
	maxPDVersion *semver.Version = semver.New("5.5.0-alpha")
	...
	maxTiKVVersion *semver.Version = semver.New("5.5.0-alpha")
	...
	maxTiCDCVersion *semver.Version = semver.New("5.5.0-alpha")
