...
require (
	...
	github.com/pingcap/tidb v1.1.0-beta.0.20200515085842-dfbb1ff8b0a8
...
replace github.com/pingcap/kvproto => github.com/MyonKeminta/kvproto v0.0.0-20200608071553-babe7a4311be
