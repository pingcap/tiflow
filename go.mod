...
require (
	...
	github.com/go-mysql-org/go-mysql v1.6.1-0.20221130104000-8206ccde58ed
	...
	github.com/pingcap/tidb v1.1.0-beta.0.20221214080051-dd42b7224298
	github.com/pingcap/tidb-tools v6.1.1-0.20220715000306-1d2f00da8c3e+incompatible
	github.com/pingcap/tidb/parser v0.0.0-20221214070652-66a2e96f2768
