...
func initServerCmd(cmd *cobra.Command) {
	...
	cmd.Flags().IntVar(&serverConfig.LogFileMaxSize, "log-file-max-size", defaultServerConfig.LogFileMaxSize, "max log file size in MB")
	cmd.Flags().IntVar(&serverConfig.LogFileMaxDays, "log-file-max-days", defaultServerConfig.LogFileMaxDays, "max log file keep days")
	cmd.Flags().IntVar(&serverConfig.LogFileMaxBackups, "log-file-max-backups", defaultServerConfig.LogFileMaxBackups, "maximum number of old log files to retain")
...
func loadAndVerifyServerConfig(cmd *cobra.Command) (*config.ServerConfig, error) {
	...
	cmd.Flags().Visit(func(flag *pflag.Flag) {
		...
		case "log-file-max-size":
			conf.LogFileMaxSize = serverConfig.LogFileMaxSize
		case "log-file-max-days":
			conf.LogFileMaxDays = serverConfig.LogFileMaxDays
		case "log-file-max-backups":
			conf.LogFileMaxBackups = serverConfig.LogFileMaxBackups
		case "data-dir":
