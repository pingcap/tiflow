...
check-static: tools/bin/golangci-lint
	tools/bin/golangci-lint run --new-from-merge-base master --timeout 10m0s --exclude-dirs "^dm/","^tests/"
	cd dm && ../tools/bin/golangci-lint run --new-from-merge-base master --timeout 10m0s
